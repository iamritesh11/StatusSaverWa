...
public class ItemOneFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        getActivity().setTitle("WhatsApp Messaging");
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (url.isEmpty()){
                    Toast.makeText(getActivity(), "Please enter whatsapp number!", Toast.LENGTH_SHORT).show();
                }
                else if (url.length()<8){
                    Toast.makeText(getActivity(), "Wrong number maybe!", Toast.LENGTH_SHORT).show();
                }
                else{
